...
if __name__ == '__main__':
    ...
    if(args.lstm):
        a2c_agent = LSTMAgent(len(SIMPLE_MOVEMENT), env, 0.99, 1e-30, 0.00025, render=True)
    else:    
        a2c_agent = Agent(len(SIMPLE_MOVEMENT), env, 0.99, 1e-30, 0.00025, render=True)
    a2c_agent.train(10000)
